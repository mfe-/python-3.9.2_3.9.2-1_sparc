...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': '/c/opt/gcc-4.6.0/bin/gcc -pthread -shared -L/usr/local/ssl/ '
              '-L/usr/local/ssl/lib/ -L/usr/local/ -L/usr/local/bin/ '
              '-Wl,-rpath,/usr/local/ssl/,-rpath,/usr/local/lib/,-rpath,/usr/local/ssl/lib/',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'sparc-unknown-linux-gnu',
 'BYTESTR_DEPS': '\\',
 'CC': '/c/opt/gcc-4.6.0/bin/gcc -pthread',
 'CCSHARED': '-fPIC',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-L/usr/local/ssl/ -L/usr/local/ssl/lib/ -L/usr/local/ '
                      '-L/usr/local/bin/ '
                      '-Wl,-rpath,/usr/local/ssl/,-rpath,/usr/local/lib/,-rpath,/usr/local/ssl/lib/',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--with-ensurepip=install' '--enable-shared' "
                "'--with-openssl=/usr/local/ssl/' '--disable-docs' "
                "'--host=sparc-linux' '--build=sparc-linux' "
                "'build_alias=sparc-linux' 'host_alias=sparc-linux' "
                "'CC=/c/opt/gcc-4.6.0/bin/gcc' 'LDFLAGS=-L/usr/local/ssl/ "
                '-L/usr/local/ssl/lib/ -L/usr/local/ -L/usr/local/bin/ '
                "-Wl,-rpath,/usr/local/ssl/,-rpath,/usr/local/lib/,-rpath,/usr/local/ssl/lib/'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/root/Python-3.9.2/coverage.info',
 'COVERAGE_REPORT': '/root/Python-3.9.2/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': '/c/opt/gcc-4.6.0/bin/g++ -pthread',
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cpython-39-sparc-linux-gnu.so',
 'FILEMODE': 644,
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'sparc-unknown-linux-gnu',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/c/opt/gcc-4.6.0/bin/g++ -pthread -shared',
 'LDFLAGS': '-L/usr/local/ssl/ -L/usr/local/ssl/lib/ -L/usr/local/ '
            '-L/usr/local/bin/ '
            '-Wl,-rpath,/usr/local/ssl/,-rpath,/usr/local/lib/,-rpath,/usr/local/ssl/lib/',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.9.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/c/opt/gcc-4.6.0/bin/gcc -pthread -shared -L/usr/local/ssl/ '
             '-L/usr/local/ssl/lib/ -L/usr/local/ -L/usr/local/bin/ '
             '-Wl,-rpath,/usr/local/ssl/,-rpath,/usr/local/lib/,-rpath,/usr/local/ssl/lib/',
 'LDVERSION': '3.9',
 'LIBC': '',
 ...
 'LIBPL': '/usr/local/lib/python3.9/config-3.9-sparc-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LINKCC': '/c/opt/gcc-4.6.0/bin/gcc -pthread',
 ...
 'MAINCC': '/c/opt/gcc-4.6.0/bin/gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 ...
 'MODBUILT_NAMES': 'posix  errno  pwd  _sre  _codecs  _weakref  _functools  '
                   ...
                   '_tracemalloc  _peg_parser  _symtable  _ssl  xxsubtype',
 'MODDISABLED_NAMES': '',
 ...
 'MODULE_OBJS': '\\',
 'MULTIARCH': 'sparc-linux-gnu',
 'MULTIARCH_CPPFLAGS': '-DMULTIARCH=\\"sparc-linux-gnu\\"',
 ...
 'PY_CORE_LDFLAGS': '-L/usr/local/ssl/ -L/usr/local/ssl/lib/ -L/usr/local/ '
                    '-L/usr/local/bin/ '
                    '-Wl,-rpath,/usr/local/ssl/,-rpath,/usr/local/lib/,-rpath,/usr/local/ssl/lib/',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/usr/local/ssl/ -L/usr/local/ssl/lib/ -L/usr/local/ '
               '-L/usr/local/bin/ '
               '-Wl,-rpath,/usr/local/ssl/,-rpath,/usr/local/lib/,-rpath,/usr/local/ssl/lib/',
 'PY_LDFLAGS_NODIST': '',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/root/Python-3.9.2:/c/opt/gcc-4.6.0/libexec/gcc/sparc-unknown-linux-gnu/4.6.0/:/c/opt/gcc-4.6.0/lib/:/c/opt/gcc-4.6.0/libexec/gcc/sparc-unknown-linux-gnu/4.6.0/:/usr/local/lib:/usr/local/ssl/lib/',
 ...
 'SIZEOF_WCHAR_T': 4,
 'SIZEOF__BOOL': 1,
 'SOABI': 'cpython-39-sparc-linux-gnu',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/root/Python-3.9.2:/c/opt/gcc-4.6.0/libexec/gcc/sparc-unknown-linux-gnu/4.6.0/:/c/opt/gcc-4.6.0/lib/:/c/opt/gcc-4.6.0/libexec/gcc/sparc-unknown-linux-gnu/4.6.0/:/usr/local/lib:/usr/local/ssl/lib/ '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/root/Python-3.9.2:/c/opt/gcc-4.6.0/libexec/gcc/sparc-unknown-linux-gnu/4.6.0/:/c/opt/gcc-4.6.0/lib/:/c/opt/gcc-4.6.0/libexec/gcc/sparc-unknown-linux-gnu/4.6.0/:/usr/local/lib:/usr/local/ssl/lib/ '
 ...
 'abs_builddir': '/root/Python-3.9.2',
 'abs_srcdir': '/root/Python-3.9.2',
